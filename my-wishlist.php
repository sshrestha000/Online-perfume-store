...
?>
				...
				<tr>
					...
					<td class="col-md-6">
						<div class="product-name"><?php echo htmlentities($row['pname']);?></a></div>
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo $row['wid'];?>" onClick="return confirm('Are you sure you want to delete?')" class="">Remove From Wishlist</a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
